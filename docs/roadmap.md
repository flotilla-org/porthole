...
through a pinned private Git dependency, with the existing macOS and Linux paths
...
- [ ] Switch porthole to a pinned Jackstay revision, configure private dependency
