...
**Completion note:** This spike now has an end-to-end real window path:
ScreenCaptureKit producer → porthole capture session → capture-transfer
shared-memory/fd-passing transport → SDL and katzensteg consumers. The current
implementation is CPU-copy-first and intentionally not optimized; performance
work should wait until the protocol and consumer surfaces settle.
...
- [x] **Step 1: Add the new workspace member**
...
- [x] **Step 3: Define the initial modules**
...
- [x] **Step 3: Implement an in-process slot manager first**
...
- [x] **Step 5: Add the local shared-memory backing**
...
- [x] **Step 1: Write Rust ABI smoke tests**
...
- [x] **Step 3: Implement opaque handles and status codes**
...
- [x] **Step 4: Run the viewer against a synthetic producer**
...
- [x] **Step 1: Write fd-passing tests**
...
- [x] **Step 3: Implement send/receive helpers**
...
- [x] **Step 1: Inspect current CLI and daemon route patterns**

Use `rg` to find the existing launch, screenshot, and route test structure before choosing exact wire files.

- [x] **Step 2: Add tests for synthetic session creation and discovery**
...
- [x] **Step 3: Implement registry state**
...
- [x] **Step 4: Implement HTTP registry routes**
...
- [x] **Step 5: Implement the raw fd-transfer side channel**
...
- [x] **Step 1: Confirm permission state before real capture**
...
- [x] **Step 5: Update the design spec if implementation changed semantics**
...
- [x] **Step 6: Commit any final docs updates**
